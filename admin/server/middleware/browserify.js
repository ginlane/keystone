...
module.exports = function (file, name) {
	...
	function build () {
		...
		b.transform(babelify.configure({
			ignore: ['**/lib/**', '**/sir-trevor/**'],
			plugins: [require('babel-plugin-object-assign'), require('babel-plugin-transform-object-rest-spread'), require('babel-plugin-transform-object-assign')],
